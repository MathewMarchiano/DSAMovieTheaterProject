...
public class MovieHouse {
    ...
    private MyListReferenceBased<String> names;
    ...
    public MovieHouse() {
        ...
        this.iterator = null;
        names = new MyListReferenceBased<String>();
    }
    ...
    public void addPartyToLine(Party party) {
        ...
        // Add to list of names currently in line
        names.add(names.size(), party.getRepresentative());
    }
    ...
    /**
     * Will check the list of names currently waiting 
     * in line if there is a name matching the name given.
     * 
     * @param name The name to check for.
     * @return Whether or not the lines already have a party 
     * under that given name.
     */
    public boolean findDupes(String name)
    {
    	boolean duplicate = false;
    	Iterator<String> it = names.iterator();
    	while(!duplicate && it.hasNext())
    	{
